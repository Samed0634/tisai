...
const KurumRegistrationForm = () => {
  ...
  const form = useForm<KurumFormValues>({
  ...
  const onSubmit = async (data: KurumFormValues) => {
    if (!user) {
      toast({
        title: "Hata",
    ...
    try {
      ...
      // Kullanıcı-kurum ilişkisini kaydet
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Textarea 
                        ...
                        placeholder="Kurumunuzun adresini giriniz"
                        {...field} 
                      />
                    </div>
                  </FormControl>
